    ...
    <header class="container-fluid mx-0 px-0">
      ...
      <div class="row d-flex align-items-center flex-row flex-md-row-reverse">
        <div class="col-12 col-md-6 text-center">
          <h1 class="overlayHeadline p-3">Shirts</h1>
          <img src="{{ secure_asset('images/female_shirts_header.png') }}" class="img-fluid w-100 h-100">
        </div>
    ...
    <div class="container-fluid">
      <div class="row mb-5" id="categories">
        <div class="col-12 col-md-3 px-0 mx-0 cat">
          <a href="#">
          <img src="{{ secure_asset('images/female_shirts1.png') }}" alt="" class="img-fluid">
          <div class="cat-overlay d-flex justify-content-center align-items-center  w-100">
            <div class="overlay-header h-50 w-100 pl-4">Female - Shirts
              <p class="overlay-text">I'm baby</p>
              <p class="price text-right">59,-</p>
            </div>
          </div>
        </a>
        </div>
        <div class="col-12 col-md-3 px-0 mx-0 cat">
          <a href="#">
          <img src="{{ secure_asset('images/female_shirts2.png') }}" alt="" class="img-fluid">
          <div class="cat-overlay d-flex justify-content-center align-items-center  w-100">
            <div class="overlay-header h-50 w-100 pl-4">Female - Shirts
              <p class="overlay-text">I'm lita ad novum</p>
              <p class="price text-right">100,-</p>
            </div>
          </div>
        </a>
        </div>
        <div class="col-12 col-md-3 px-0 mx-0 cat">
          <a href="#">
          <img src="{{ secure_asset('images/female_shirts3.png') }}" alt="" class="img-fluid">
          <div class="cat-overlay d-flex justify-content-center align-items-center  w-100">
            <div class="overlay-header h-50 w-100 pl-4">Female - Shirts
        ...
        <div class="col-12 col-md-3 px-0 mx-0 cat">
          <a href="#">
          <img src="{{ secure_asset('images/male_shirts1.png') }}" alt="" class="img-fluid">
          <div class="cat-overlay d-flex justify-content-center align-items-center  w-100">
            <div class="overlay-header h-50 w-100 pl-4">Male - Shirts
        ...
        <div class="col-12 col-md-3 px-0 mx-0 cat">
          <a href="#">
          <img src="{{ secure_asset('images/male_shirts2.png') }}" alt="" class="img-fluid">
          <div class="cat-overlay d-flex justify-content-center align-items-center  w-100">
            <div class="overlay-header h-50 w-100 pl-4">Male - Shirts
        ...
        <div class="col-12 col-md-3 px-0 mx-0 cat">
          <a href="#">
          <img src="{{ secure_asset('images/male_shirts3.png') }}" alt="" class="img-fluid">
          <div class="cat-overlay d-flex justify-content-center align-items-center  w-100">
            <div class="overlay-header h-50 w-100 pl-4">Male - Shirts
