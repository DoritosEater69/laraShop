    ...
    <div class="container-fluid">
      <div class="row mb-5" id="categories">
        <div class="col-12 col-md-3 px-0 mx-0 cat">
          <a href="#">
          <img src="{{ secure_asset('images/female_shoes1.png') }}" alt="" class="img-fluid">
          <div class="cat-overlay d-flex justify-content-center align-items-center  w-100">
            <div class="overlay-header h-50 w-100 pl-4">Female - Shoes
        ...
        <div class="col-12 col-md-3 px-0 mx-0 cat">
          <a href="#">
          <img src="{{ secure_asset('images/male_shoes1.png') }}" alt="" class="img-fluid">
          <div class="cat-overlay d-flex justify-content-center align-items-center  w-100">
            <div class="overlay-header h-50 w-100 pl-4">Unisex - Shoes
        ...
        <div class="col-12 col-md-3 px-0 mx-0 cat">
          <a href="#">
          <img src="{{ secure_asset('images/male_shoes2.png') }}" alt="" class="img-fluid">
          <div class="cat-overlay d-flex justify-content-center align-items-center  w-100">
            <div class="overlay-header h-50 w-100 pl-4">Unisex - Shoes
        ...
        <div class="col-12 col-md-3 px-0 mx-0 cat">
          <a href="#">
          <img src="{{ secure_asset('images/male_shoes3.png') }}" alt="" class="img-fluid">
          <div class="cat-overlay d-flex justify-content-center align-items-center  w-100">
            <div class="overlay-header h-50 w-100 pl-4">Unisex - Shoes
        ...
        <div class="col-12 col-md-3 px-0 mx-0 cat">
          <a href="#">
          <img src="{{ secure_asset('images/male_shoes4.png') }}" alt="" class="img-fluid">
          <div class="cat-overlay d-flex justify-content-center align-items-center  w-100">
            <div class="overlay-header h-50 w-100 pl-4">Unisex - Shoes
        ...
        <div class="col-12 col-md-3 px-0 mx-0 cat">
          <a href="#">
          <img src="{{ secure_asset('images/male_shoes5.png') }}" alt="" class="img-fluid">
          <div class="cat-overlay d-flex justify-content-center align-items-center  w-100">
            <div class="overlay-header h-50 w-100 pl-4">Unisex - Shoes
